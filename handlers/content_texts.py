...
class BotTexts:
    ...
    LEVEL_2_NAME = "Охотник"
    LEVEL_3_NAME = "Легенда"
    ...
    # =========================================================
    BONUS_1_MENU_TITLE = "🔒 Секретный бонус 1"
    BONUS_2_MENU_TITLE = "🔒 Секретный бонус 2"
    ...
    def materials_menu(cls) -> str:
        return "📂 Таблицы и документы — выбери материал:"
    ...
    def material_opened(
        ...
        return (
            f"✅ Разблокирован документ {material_name}:\n"
            f"{material_link}\n\n"
            "🎁 Следующая миссия: поднять уровень персонажа\n"
