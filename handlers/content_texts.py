...
FIRST_NOT_SUBSCRIBED_TEXT = (
    ...
    "разборами проектов, ошибками, метриками, точками роста, "
    "монетизацией, retention, фичами, гипотезами и рабочими материалами, "
    "которые можно сразу применять в своей игре.\n\n"
    "Внутри канала:\n"
    "• разборы игровых механик и проектов\n"
    "• полезные таблицы и документы\n"
    "• туториалы и прикладные материалы\n"
    "• мысли про геймдев, продукт и рост игры\n"
    "• секретные бонусы для самых активных\n\n"
...
class BotTexts:
    ...
    def game_review_intro(cls) -> str:
        return (
            ...
            "Стоимость — от 7 до 30 тыс. в зависимости от проекта.\n\n"
